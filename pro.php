...
<div class="testbox">
  ...
  <form method="POST" action="regw.php">
  ...
  <input type="number" name="phn" placeholder="mobile" required/>
   ...
   <a href="regsuc.php" class="button"><input type="submit" name="submit" value="Submit"></a>
  </form>
</div>
</html>